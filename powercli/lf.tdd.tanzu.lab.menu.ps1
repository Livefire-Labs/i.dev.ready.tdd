...
function Show-Menu
{
     ...
     Write-Host “ DO NOT USE FOR NOW - 2: Press '2' to deploy Supervisor Cluster.”
     Write-Host “ DO NOT USE FOR NOW - No Reason..? 3: Press '3' To add Certificate top Supervisor.”
